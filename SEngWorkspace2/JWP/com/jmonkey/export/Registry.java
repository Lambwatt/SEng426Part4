...
public abstract class Registry {
  ...
  public static final File RESOURCE_DIRECTORY = 
    new File(Runtime.ensureDirectory(System.getProperty("user.home") +
                                     FS + ".lexi" + FS + "export"));

  public static final File REGISTRY_DIRECTORY = 
    new File(Runtime.ensureDirectory(RESOURCE_DIRECTORY.getAbsolutePath() + 
                                     FS + "registry"));
   ...
   */
  public abstract boolean getBoolean(String group, String key)
   ...
   * @throws RegistryPropertyException if the property is missing.
   */
  public abstract byte getByte(String group, String key)
    throws RegistryPropertyException;
   ...
   * @throws RegistryPropertyException if the property is missing.
   */
  public abstract byte[] getByteArray(String group, String key)
    throws RegistryPropertyException;
   ...
   * @throws RegistryPropertyException if the property is missing.
   */
  public abstract char getChar(String group, String key)
    throws RegistryPropertyException;
   ...
   * @throws RegistryPropertyException if the property is missing.
   */
  public abstract char[] getCharArray(String group, String key)
    throws RegistryPropertyException;
   ...
   * @throws RegistryPropertyException if the property is missing.
   */
  public abstract double getDouble(String group, String key)
    throws RegistryPropertyException;
   ...
   * @throws RegistryPropertyException if the property is missing.
   */
  public abstract float getFloat(String group, String key)
    throws RegistryPropertyException;
   ...
   * @throws RegistryPropertyException if the property is missing.
   */
  public abstract int getInteger(String group, String key)
    throws RegistryPropertyException;
   ...
   * @throws RegistryPropertyException if the property is missing.
   */
  public abstract long getLong(String group, String key)
    throws RegistryPropertyException;
   ...
   * @throws RegistryPropertyException if the property is missing.
   */
  public abstract Object getObject(String group, String key)
    throws RegistryPropertyException;
   ...
   * @throws RegistryPropertyException if the property is missing.
   */
  public abstract short getShort(String group, String key)
    throws RegistryPropertyException;
   ...
   * @throws RegistryPropertyException if the property is missing.
   */
  public abstract String getString(String group, String key)
    throws RegistryPropertyException;
   ...
   * @throws RegistryPropertyException if the property is missing.
   */
  public abstract int getType(String group, String key)
    throws RegistryPropertyException;
   ...
   */
  public static Registry loadForClass(Class requestingClass)
      throws IOException {
  ...
  public static Registry loadForClass(Class requestingClass, 
      ...
      throws IOException {
    return Registry.loadForName(requestingClass.getName(), requestedVersion,
                                false);
  }
   ...
   * @throws IOException if the Registry file cannot be read or created.
   */
  public static Registry loadForName(String name, int[] requestedVersion)
  throws IOException {
   ...
   */
  public static Registry loadForReader(Reader reader, 
                                             int[] requestedVersion) 
  throws IOException {
   ...
   * @param value the value to set
   */
  public abstract void setProperty(String group, String key, 
                                   Serializable[] value);
